...
const sentence =
  "I'm a Computer Science & Engineering undergraduate dedicated to creating innovative solutions through technology. Join me in my journey as I explore the intersection of code and creativity.";
      ...
      <div className="flex flex-col justify-center items-start p-10 sm:p-0 sm:ml-40 sm:w-2/5 z-10">
        ...
        >
          ...
          <Link
            href="/cv.pdf"
            download
            className="border-2 border-blue-600 text-blue-700 font-semibold py-3 px-6 rounded-full hover:bg-blue-50 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 ml-5"
          >
            Download CV
          </Link>
        </motion.div>
